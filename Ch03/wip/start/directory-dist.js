      ...
      React.createElement(
        ...
        props.people.map(function (person) {
          return React.createElement(
            ...
            { key: person.id, classNames: "fade", timeout: 20 },
  ...
  function Filters(props) {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "select",
          { name: "person-title", id: "person-title", value: props.currentTitle, onChange: updateTitle },
          React.createElement(
            "option",
            { value: "" },
            "- Select -"
      ...
      React.createElement(
        ...
        React.createElement(
          "label",
          null,
          React.createElement("input", { type: "checkbox", value: "1", name: "person_intern", checked: props.isIntern,
      ...
      React.createElement(
        "div",
        { className: "group" },
        React.createElement("input", { type: "reset", name: "Reset", value: "Reset", onClick: resetForm })
      )
    );
  }
